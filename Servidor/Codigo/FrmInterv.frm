   ...
   Begin VB.Frame Frame12 
      ...
      Begin VB.Frame Frame7 
         ...
         Begin VB.TextBox txtCmdExec 
            ...
            Width           =   915
         End
         Begin VB.TextBox txtStaminaIntervaloLluvia 
            Height          =   300
            Left            =   1320
            TabIndex        =   43
            Text            =   "0"
...
StaminaIntervaloLluvia = val(txtStaminaIntervaloLluvia.Text)
...
Call WriteVar(IniPath & "Server.ini", "INTERVALOS", "StaminaIntervaloLluvia", str(StaminaIntervaloLluvia))
