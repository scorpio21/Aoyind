...
'***************************************************
    ...
    If OtroUserIndex = 0 Then Exit Sub
    ' Acepto el otro?
            ...
            If Not .Confirmo Then
                ...
                ' Agreamos (o quitamos) el item y su cantidad en el slot correspondiente
                    ...
                    If ItemNewbie(ObjIndex) Then
                        Call WriteConsoleMsg(UserIndex, "No puedes vender tus items newbies.", FontTypeNames.FONTTYPE_INFO)
                        Exit Sub
                    End If
                    If ObjData(ObjIndex).Real = 1 Or ObjData(ObjIndex).Caos = 1 Then
